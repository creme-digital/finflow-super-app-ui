...
export function AddCardDialog({
  ...
  return <Dialog open={open} onOpenChange={onOpenChange}>
      ...
      WebkitBackdropFilter: 'blur(10px)'
        ...
        {/* Content */}
        <div className="flex flex-col gap-4 p-4 overflow-auto" style={{
        maxHeight: '500px'
      }}>
          ...
          <div className="space-y-3">
            ...
            <div className="space-y-2">
              ...
              <Input id="cardHolder" value={formData.cardHolder} onChange={e => handleInputChange('cardHolder', e.target.value)} placeholder="Enter card holder name" />
            </div>

            {/* Nickname */}
            <div className="space-y-2">
              <Label htmlFor="nickname">Nickname</Label>
              <Input id="nickname" value={formData.nickname} onChange={e => handleInputChange('nickname', e.target.value)} placeholder="Enter card nickname" />
            </div>

            {/* Card Type */}
            <div className="space-y-3">
              <Label>Card Type</Label>
              <RadioGroup value={formData.cardType} onValueChange={value => handleInputChange('cardType', value)} className="flex gap-2">
          ...
          <div className="space-y-3">
            ...
            <div className="space-y-2">
              ...
              <div className="relative">
                ...
                <Input id="maxSpendingMonth" type="number" value={formData.maxSpendingMonth} onChange={e => handleInputChange('maxSpendingMonth', e.target.value)} placeholder="0.00" className="pl-8" step="0.01" min="0" />
              </div>
            </div>
            ...
            <div className="space-y-2">
              ...
              <Input id="maxTransactionsMonth" type="number" value={formData.maxTransactionsMonth} onChange={e => handleInputChange('maxTransactionsMonth', e.target.value)} placeholder="Enter maximum transactions" min="0" />
            </div>
            ...
            <div className="space-y-2">
              ...
              <div className="relative">
                <span className="absolute left-3 top-1/2 transform -translate-y-1/2 text-muted-foreground">$</span>
                <Input id="maxSpendingTransaction" type="number" value={formData.maxSpendingTransaction} onChange={e => handleInputChange('maxSpendingTransaction', e.target.value)} placeholder="0.00" className="pl-8" step="0.01" min="0" />
              </div>
            </div>
          </div>
          ...
          <div className="space-y-3">
            ...
            <div className="space-y-2">
              ...
              <div className="relative">
                <span className="absolute left-3 top-1/2 transform -translate-y-1/2 text-muted-foreground">$</span>
                <Input id="dailySpendingLimit" type="number" value={formData.dailySpendingLimit} onChange={e => handleInputChange('dailySpendingLimit', e.target.value)} placeholder="0.00" className="pl-8" step="0.01" min="0" />
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="flex gap-2 p-4 border-t border-border">
          <Button variant="secondary" onClick={handleCancel} className="flex-1 rounded-full">
            Cancel
          </Button>
