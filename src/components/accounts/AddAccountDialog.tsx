      ...
      WebkitBackdropFilter: 'blur(10px)'
        ...
        maxHeight: '500px'
          ...
          <div className="space-y-2">
            ...
            <Input id="accountName" value={formData.accountName} onChange={e => handleInputChange('accountName', e.target.value)} placeholder="Enter account name" />
          </div>
          ...
          <div className="space-y-2">
            ...
            <Select value={formData.currency} onValueChange={value => handleInputChange('currency', value)}>
              ...
              <SelectContent>
                {currencies.map(currency => <SelectItem key={currency.value} value={currency.value}>
