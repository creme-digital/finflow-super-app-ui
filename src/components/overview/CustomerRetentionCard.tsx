      ...
      <div className="flex-1 p-4">
        ...
        height: '280px'
          ...
          <ChartContainer config={chartConfig} className="w-full h-full">
            <BarChart data={retentionData} margin={{
            top: 10,
            right: 10,
            left: 0,
            bottom: 10
              ...
              <Bar dataKey="new" fill={chartConfig.new.color} radius={[24, 24, 0, 0]} maxBarSize={32} />
              <Bar dataKey="return" fill={chartConfig.return.color} radius={[24, 24, 0, 0]} maxBarSize={32} />
            </BarChart>
          </ChartContainer>
        </div>
        ...
        <div className="flex gap-4 mt-2 justify-center">
          ...
          <div className="flex items-center gap-2">
            <div className="w-3 h-3 rounded-full" style={{
            backgroundColor: chartConfig.return.color
          }} />
