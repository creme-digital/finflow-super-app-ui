      ...
      <div className="flex-1 p-4">
        ...
        height: '280px'
          ...
          <ChartContainer config={chartConfig} className="w-full h-full">
            <LineChart data={customerData} margin={{
            top: 5,
            right: 5,
            left: 5,
            bottom: 5
              ...
              <Line type="monotone" dataKey="thisMonth" stroke={chartConfig.thisMonth.color} strokeWidth={3} dot={false} activeDot={{
              r: 6,
              fill: chartConfig.thisMonth.color,
              stroke: '#fff',
              strokeWidth: 2
            }} />
              <Line type="monotone" dataKey="lastMonth" stroke={chartConfig.lastMonth.color} strokeWidth={3} dot={false} activeDot={{
              r: 6,
        ...
        <div className="flex gap-4 mt-2 justify-center">
          <div className="flex items-center gap-2">
            ...
            backgroundColor: chartConfig.thisMonth.color
          }} />
            <span className="text-sm text-muted-foreground">This Month</span>
          </div>
          <div className="flex items-center gap-2">
            <div className="w-3 h-3 rounded-full" style={{
            backgroundColor: chartConfig.lastMonth.color
          }} />
