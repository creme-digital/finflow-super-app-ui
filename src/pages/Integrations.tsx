...
const IntegrationsMainContent = () => {
  ...
  const IntegrationCard = ({ integration }: { integration: any }) => (
    ...
    >
      <CardContent className="p-6 space-y-4 h-full flex flex-col">
        ...
        <Button 
          variant="ghost" 
          className="text-blue-600 hover:text-blue-700 p-0 h-auto font-medium text-sm self-start"
        >
          Learn More
  ...
  const CategorySection = ({ title, integrations }: { title: string; integrations: any[] }) => (
...
export default function Integrations() {
  return (
    <Layout 
      ...
      mainContent={<IntegrationsMainContent />}
    />
  );
}
